...
export const postNote = createAsyncThunk<NoteType, string | undefined, { state: RootState }>(
    "data/postNote",
...
export const patchNote = createAsyncThunk<NoteType, {id: string, text?: string, addTagId?: string, deleteTagId?: string, bin?: boolean}, { state: RootState }>(
    "data/patchNote",
    async ({ id, text, addTagId, deleteTagId, bin }, { dispatch, rejectWithValue, getState }) => {
...
export const postTag = createAsyncThunk<{id: string, noteId: string}, {tagName: string, noteId?: string}, { state: RootState }>(
    "data/postTag",
...
export const patchTag = createAsyncThunk<void, { id: string, name?: string, addNoteId?: string, deleteNoteId?: string }, { state: RootState }>(
    "data/patchTag",
    async ({ id, name, addNoteId, deleteNoteId }, { dispatch, rejectWithValue }) => {
        try {
